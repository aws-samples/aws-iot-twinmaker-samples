...
export function AlarmHighIcon({ children, className, ...props }: ComponentProps) {
  return (
    <svg className={createClassName(baseStyles.svg, className)} viewBox="0 0 22 22" {...props}>
      <path
...
export function AlarmMediumIcon({ children, className, ...props }: ComponentProps) {
  return (
...
export function AlarmLowIcon({ children, className, ...props }: ComponentProps) {
  return (
    <svg className={createClassName(baseStyles.svg, className)} viewBox="0 0 22 19" {...props}>
      <path
