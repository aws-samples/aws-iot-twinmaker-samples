...
export const NODE_DIAMOND_DEFAULT_SIZE = 115;
export const NODE_HEXAGON_DEFAULT_SIZE = 110;
export const NODE_ELLIPSE_DEFAULT_SIZE = 100;
export const NODE_RECTANGLE_DEFAULT_SIZE = 90;
